        ...
        <a href="{{ '/tools/scribd-exporter/' | relative_url }}" class="project-card-link">
          <div class="card hoverable h-100">
            <div class="card-body">
              ...
              <p class="card-text">Paste a Scribd link and get the whole document back as a single PDF, or a single zip of page images — one bookmark, nothing to install.</p>
            </div>
          </div>
        </a>
      </div>
